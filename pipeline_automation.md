...
| [docs/outlier_system.md](docs/outlier_system.md) | **Competitor outlier database** — free YouTube Data API scan of the 15-channel comp set → `data/outliers.csv`, formula tagging, weekly Action | Setting up / running packaging research; the Packaging precedent check |
