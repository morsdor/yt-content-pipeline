...
| [formula_library.md](formula_library.md) | **Title formula library** — the canonical F1–F11 patterns (driver, niche example, failure mode); §4 points here, Phase −1 generates from it, `tag_outliers.py` tags against it | Writing or judging titles; growing the pattern list |
